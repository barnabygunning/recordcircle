...
export const MIN_ANGLE = -24
export const MAX_ANGLE = 24
export const DEFAULT_ANGLE_STEP = 2 // Default angular spacing between adjacent albums
export const MIN_ANGLE_STEP = 1
export const MAX_ANGLE_STEP = 3

// Radius settings
export const DEFAULT_RADIUS = 9000 // Default radius for trigonometric positioning
export const MIN_RADIUS = 2000
export const MAX_RADIUS = 10000

// Cover art settings
export const DEFAULT_COVER_SCALE = 0.36 // Default cover art scaling factor (36% of viewport)
